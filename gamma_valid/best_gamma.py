...
print("Gamma:\tAccuracy_Test:\t\tAccuracy_Valid:\t\tf1_test:\t\tf1_valid:")
...
while gmvalue!=1000:
        ...
        if metrics.accuracy_score(y_pred=predicted2, y_true=y_val) > max:
                gamma_best = gmvalue
                max = metrics.accuracy_score(y_pred=predicted2, y_true=y_val)
        gmvalue = gmvalue*10
        ###############################################################################
        ...
        acc2 = metrics.accuracy_score(y_pred=predicted2, y_true=y_val)
        f1_valid = metrics.f1_score(y_pred=predicted2, y_true=y_val, average='macro')
        print("{}\t{}\t{}\t{}\t{}".format(gmvalue, acc1, acc2, f1_test, f1_valid))
print("Best Gamma Value is :{}\t".format(gamma_best))
